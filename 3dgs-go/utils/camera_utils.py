...
def loadCam(args, 
    ...
    if cam_info.is_dust3r:
        return Camera_w_pose(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, CX=cam_info.CX, CY=cam_info.CY,
        ...
        return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, CX=cam_info.CX, CY=cam_info.CY,   FX=cam_info.FX, FY=cam_info.FY, 
                      FoVx=cam_info.FovX, FoVy=cam_info.FovY, 
                      image=gt_image, gt_alpha_mask=loaded_mask, mono_depth=mono_depth,
                      image_name=cam_info.image_name, uid=id, 
                      data_device=args.data_device, white_background=args.white_background)
