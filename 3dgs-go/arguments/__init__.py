...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_silhouette_interpCams = 1.0 # [default 1.0] use bce loss for silhouette of random poses
        # self.lambda_silhouette = 0.1 # [default 0.01] use bce loss for silhouette
        # self.lambda_silhouette_interpCams = 0.01 # [default 1.0] use bce loss for silhouette of random poses
        # self.lambda_silhouette = 0.01 # [default 0.01] use bce loss for silhouette
        # self.lambda_silhouette_interpCams = 1.0 # [default 1.0] use bce loss for silhouette of random poses
