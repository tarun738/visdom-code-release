...
def clean_mesh(verts, faces, v_pct=1, min_f=20, min_d=2, repair=True, remesh=True, remesh_size=0.01, logger=None, main_process=True):
    # verts: [N, 3]
    # faces: [N, 3]
...
def main(unused_argv):
    ...
    config.mesh_path = os.path.join(config.exp_path, "mesh")
